...
def wonka():
    ...
    win_label= Label(parent, text= "DESCRIPTION : Wonka tells the wondrous story of how the world`s greatest inventor,", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=470)
    win_label= Label(parent, text= "magician and chocolate-maker became the beloved Willy Wonka we know today.", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=500)
    win_label= Label(parent, text= "Cast: Timothée Chalamet . Olivia Colman . Hugh Grant", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=530)
    win_label= Label(parent, text= "Director: Paul King", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=560)
    win_label= Label(parent, text= "Producer: Simon Farnaby", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=590)
    win_label= Label(parent, text= "Co-Producer: Rosie Alison", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=620)
    win_label= Label(parent, text= "Screenplay: Kevin J. Walsh", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=650)
    win_label= Label(parent, text= "Director Of Photography: Chung-hoon Chung", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    win_label.place(x=25, y=680)
    win_label= Label(parent, text= "Music: Joby Talbot", font= ('Roman', 17), fg= "black",bg="antiquewhite3")
    ...
    image1 = Image.open("wonkamain.png")
    test = ImageTk.PhotoImage(image1)
    label1s = tk.Label(parent,image=test)    
    # Position image
    label1s.place(x=3, y=100) 
    ############################################################################
    parent.mainloop()
